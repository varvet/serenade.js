    ...
    value: function toJSON() {
      ...
      this._s.properties.forEach(function (property) {
        if (typeof property.serialize === 'string') {
          serialized[property.serialize] = (0, _helpers.serializeObject)(_this3[property.name]);
        } else if (typeof property.serialize === 'function') {
          var _property$serialize$call = property.serialize.call(_this3);
          ...
          serialized[property.name] = (0, _helpers.serializeObject)(_this3[property.name]);
        }
      });
      return serialized;
    }
