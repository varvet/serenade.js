...
var FilteredChannel = (function (_DerivedChannel) {
  _inherits(FilteredChannel, _DerivedChannel);

  function FilteredChannel(parent, fn) {
    _classCallCheck(this, FilteredChannel);

    _get(Object.getPrototypeOf(FilteredChannel.prototype), "constructor", this).call(this, parent);
...
_base_channel2["default"].prototype.filter = function (fn) {
