...
var MappedChannel = (function (_DerivedChannel) {
  _inherits(MappedChannel, _DerivedChannel);

  function MappedChannel(parent, fn) {
    _classCallCheck(this, MappedChannel);

    _get(Object.getPrototypeOf(MappedChannel.prototype), "constructor", this).call(this, parent);
    this.fn = fn;
  }
