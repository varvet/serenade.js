...
var AsyncChannel = (function (_DerivedChannel) {
  _inherits(AsyncChannel, _DerivedChannel);

  function AsyncChannel(parent, queueName) {
    _classCallCheck(this, AsyncChannel);

    _get(Object.getPrototypeOf(AsyncChannel.prototype), "constructor", this).call(this, parent);
    this.queue = _helpers.settings.eventManager.queues[queueName];
...
exports["default"] = AsyncChannel;

_base_channel2["default"].prototype.async = function (queue) {
