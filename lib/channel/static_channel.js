...
var StaticChannel = (function (_BaseChannel) {
  _inherits(StaticChannel, _BaseChannel);

  function StaticChannel(value) {
    _classCallCheck(this, StaticChannel);

    _get(Object.getPrototypeOf(StaticChannel.prototype), "constructor", this).call(this);
    this.value = value;
  }
