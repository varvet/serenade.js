...
var DynamicView = (function (_View) {
  ...
  function DynamicView(channel, fn) {
    _classCallCheck(this, DynamicView);

    _get(Object.getPrototypeOf(DynamicView.prototype), "constructor", this).call(this, _helpers.settings.document.createTextNode(''), channel, fn);
    this.items = [];
