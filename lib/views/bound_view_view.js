...
var BoundViewView = (function (_DynamicView) {
  ...
  function BoundViewView() {
    ...
    _get(Object.getPrototypeOf(BoundViewView.prototype), "constructor", this).apply(this, arguments);
  }

  _createClass(BoundViewView, [{
    key: "attach",
    value: function attach() {
      ...
      if (!this.attached) {
        this._bindToModel(this.ast.argument, function (value) {
          var view = _helpers.settings.templates[value].render(_this.context).view;
          _this.replace([view]);
        });
      }
      _get(Object.getPrototypeOf(BoundViewView.prototype), "attach", this).call(this);
    }
  }]);
