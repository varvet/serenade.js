...
var BoundViewView = (function (_DynamicView) {
  ...
  function BoundViewView(ast, context) {
    ...
    _get(Object.getPrototypeOf(BoundViewView.prototype), "constructor", this).call(this);
    this.ast = ast;
    this.context = context;

    this.bind(_compile2["default"].parameter(ast.arguments[0], context), function (value) {
...
_compile2["default"].view = function (ast, context) {
  ...
  if (ast.arguments[0].bound) {
    ...
    return _helpers.settings.templates[ast.arguments[0].value].render(context).view;
  }
};
