...
var Property = {
  style: {
    update: function update(property, value) {
      (0, _helpers.assignUnlessEqual)(this.node.style, property.name, value);
    }
  },
  event: {
    ...
    setup: function setup(property) {
      ...
      var domUpdated = function domUpdated() {
        if (_this2.node.type === "checkbox") {
          _this2.context[property.value] = _this2.node.checked;
        } else if (_this2.node.type === "radio") {
          if (_this2.node.checked) {
            _this2.context[property.value] = _this2.node.value;
          }
        } else {
          _this2.context[property.value] = _this2.node.value;
        }
  ...
  function Element(ast, context) {
    ...
    ast.properties.forEach(function (property) {
      ...
      if (action) {
        ...
        if (action.update) {
          if (property["static"]) {
            action.update.call(_this3, property, _this3.context[property.value]);
          } else if (property.bound) {
            if (property.value) {
              _this3._bindToModel(property.value, function (value) {
            ...
            action.update.call(_this3, property, property.value);
          }
        } else if (property.bound) {
