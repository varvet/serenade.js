...
var Property = {
  style: {
    update: function update(property, value) {
      (0, _helpers.assignUnlessEqual)(this.node.style, property.name, (0, _helpers.format)(this.context, property.value, value));
    }
  },
  event: {
    ...
    update: function update(property, value) {
      if (property.name === 'value') {
        ...
        if (this.node.getAttribute(property.name) !== value) {
          this.node.setAttribute(property.name, (0, _helpers.format)(this.context, property.value, value));
        }
      }
    }
  },
