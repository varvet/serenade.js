      ...
      if (action.update) {
        (function () {
          var update = function update(value) {
            ...
            var values = property.arguments.map(function (argument) {
              var value = undefined;
              if (argument.bound || argument["static"]) {
                if (argument.value) {
                  value = _this3.context[argument.value];
                } else {
                  value = _this3.context;
                }
              } else {
            ...
            action.update.call(_this3, property, values);
          };

          property.arguments.forEach(function (argument) {
            if (argument.value && argument.bound) {
              _this3._bindToModel(argument.value, update);
            }
          });

          update();
        })();
      } else if (property.arguments.some(function (argument) {
