...
var IfView = (function (_DynamicView) {
  ...
  function IfView() {
    ...
    _get(Object.getPrototypeOf(IfView.prototype), "constructor", this).apply(this, arguments);
  }
    ...
    value: function attach() {
      ...
      if (!this.attached) {
        this._bindToModel(this.ast.argument, function (value) {
          if (value) {
            _this.replace([new _template_view2["default"](_this.ast.children, _this.context)]);
          } else if (_this.ast["else"]) {
            _this.replace([new _template_view2["default"](_this.ast["else"].children, _this.context)]);
          } else {
            _this.clear();
          }
        });
      }
      _get(Object.getPrototypeOf(IfView.prototype), "attach", this).call(this);
    }
  }]);
