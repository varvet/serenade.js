...
var CollectionView = (function (_DynamicView) {
  ...
  _createClass(CollectionView, [{
    ...
    value: function attach() {
      if (!this.attached) {
        var items = this.context[this.ast.argument];
        this.replace(items);
        this._bindEvent(this.context["" + this.ast.argument + "_property"], this.update);
        this._bindEvent(items && items.change, this.cb);
      }
      _get(Object.getPrototypeOf(CollectionView.prototype), "attach", this).call(this);
    }
  }, {
    key: "update",
    ...
    value: function replace(items) {
      ...
      if (this.lastItems.length) {
        ...
        _get(Object.getPrototypeOf(CollectionView.prototype), "replace", this).call(this, items.map(function (item) {
          return _this2._toView(item);
        }));
      }
