...
var InView = (function (_DynamicView) {
  ...
  function InView() {
    ...
    _get(Object.getPrototypeOf(InView.prototype), "constructor", this).apply(this, arguments);
  }
    ...
    value: function attach() {
      ...
      if (!this.attached) {
        this._bindToModel(this.ast.argument, function (value) {
          if (value) {
            _this.replace([new _template_view2["default"](_this.ast.children, value)]);
          } else {
            _this.clear();
          }
        });
      }
      _get(Object.getPrototypeOf(InView.prototype), "attach", this).call(this);
    }
  }]);
