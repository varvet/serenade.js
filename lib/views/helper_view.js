...
var HelperView = (function (_DynamicView) {
  ...
  _createClass(HelperView, [{
    ...
    value: function attach() {
      ...
      if (!this.attached) {
        this.ast.arguments.forEach(function (_ref) {
          ...
          if (bound === true) {
            _this._bindEvent(_this.context["" + value + "_property"], _this.update);
          }
        });
        this.update();
      }
      _get(Object.getPrototypeOf(HelperView.prototype), "attach", this).call(this);
    }
  }, {
    key: "update",
    value: function update() {
      ...
      this.replace(normalize((_helper = this.helper).call.apply(_helper, [{
