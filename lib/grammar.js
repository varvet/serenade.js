...
break;
case 5: this.$ = { name: $$[$0-2], options: [{ name: "id", value: $$[$0] }], type: "element" } 
break;
case 6: this.$ = { name: "div", options: [{ name: "id", value: $$[$0] }], type: "element" } 
break;
...
break;
case 16: this.$ = { type: "content", arguments: [{ value: $$[$0], bound: true }] } 
break;
case 17: this.$ = { type: "content", arguments: [{ value: $$[$0] }] } 
break;
case 18: this.$ = $$[$0] 
break;
case 19: this.$ = $$[$0] 
...
break;
case 31: this.$ = { children: [], type: "view" } 
break;
case 32: this.$ = { children: [], type: "collection" } 
break;
case 33: this.$ = { children: [], type: "unless" } 
break;
case 34: this.$ = { children: [], type: "in" } 
break;
case 35: this.$ = { children: [], type: $$[$0] } 
break;
case 36: this.$ = $$[$0] 
break;
case 37: $$[$0-2].arguments = ($$[$0-2].arguments || []).concat($$[$0]); this.$ = $$[$0-2] 
break;
