...
var _defineProperty = require("./property");
...
var _extend$settings = require("./helpers");
...
function Serenade(wrapped) {
	...
	for (var key in wrapped) {
		_defineProperty2["default"](object, key, { value: wrapped[key] });
	}
	return object;
};

if (typeof window !== "undefined") {
	_extend$settings.settings.document = window.document;
}

_extend$settings.extend(Serenade, Object.defineProperties({
	VERSION: "0.5.0",
	defineProperty: _defineProperty2["default"],
	defineEvent: _defineEvent2["default"],
	...
	async: {
		get: function () {
			return _extend$settings.settings.async;
		},
		set: function (value) {
			_extend$settings.settings.async = value;
		},
		configurable: true,
		enumerable: true
	},
	document: {
		get: function () {
			return _extend$settings.settings.document;
		},
		set: function (value) {
			_extend$settings.settings.document = value;
		},
		configurable: true,
		enumerable: true
	},
	views: {
		get: function () {
			return _extend$settings.settings.views;
		},
		set: function (value) {
			_extend$settings.settings.views = value;
		},
		configurable: true,
		enumerable: true
	},
	templates: {
		get: function () {
			return _extend$settings.settings.templates;
		},
		set: function (value) {
			_extend$settings.settings.templates = value;
		},
		configurable: true,
		enumerable: true
	}
