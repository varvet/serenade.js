...
var Collection = (function () {
	...
	_createClass(Collection, [{
		...
		value: function concat() {
			...
			return new Collection((_toArray = this.toArray()).concat.apply(_toArray, args));
		}
	}, {
		key: "toArray",
		...
		value: function toJSON() {
			return _serializeObject.serializeObject(this.toArray());
		}
	}]);
...
_defineEvent2["default"](Collection.prototype, "change");
